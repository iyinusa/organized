                ...
                <div class="col-lg-12">
                    ...
                    <div class="block" style="overflow:auto;">
                        ...
                        <div class="block-title">
                            <h2><i class="gi gi-cargo"></i>&nbsp;Manage Product Category
                        </div>
                        <!-- END Meta Data Title -->
                        ...
                        <?php echo form_open_multipart('products/add_cat'.$edit, array('class'=>'form-horizontal form-bordered')); ?>
																...
																<tr>
																	...
																	<td class="text-center">
																		<div class="btn-group btn-group-xs">
																			<a href="'.base_url('products/add_cat?e='.$c->id.'&s='.$store->id.'').'" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
																			<a href="'.base_url('products/add_cat?r='.$c->id.'&s='.$store->id.'').'" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
																		</div>
																	</td>
																</tr>
															';	
