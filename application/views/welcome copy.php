...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="You business in your palm. Better approach to getting your business well organized with your customers">
        ...
        <div id="page-container">
                ...
                <div class="container">
                    ...
                    <nav>
                        ...
                        <ul class="site-nav">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>">Pricing</a>
                            </li>
                            <li>
                        ...
                        <section class="site-section site-section-light site-section-top themed-background-default">
                            <div class="container">
                                ...
                                <p class="text-center animation-fadeIn">
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_desktop_left.png" alt="Promo Image 1">
                                </p>
                            </div>
                        </section>
                    </div>
                        ...
                        <section class="site-section site-section-light site-section-top themed-background-fire">
                            <div class="container">
                                ...
                                <p class="text-center animation-fadeInLeft">
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_desktop_right.png" alt="Promo Image 2">
                                </p>
                            </div>
                        </section>
                    </div>
                        ...
                        <section class="site-section site-section-light site-section-top themed-background-amethyst">
                            <div class="container">
                                ...
                                <p class="text-center animation-hatch">
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_mobile.png" alt="Promo Image 3">
                                </p>
                            </div>
                        </section>
                    </div>
                        ...
                        <section class="site-section site-section-light site-section-top themed-background-modern">
                            <div class="container">
                                ...
                                <p class="text-center animation-fadeIn360">
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_tablet.png" alt="Promo Image 4">
                                </p>
                            </div>
                        </section>
                    </div>
            ...
            <section class="site-content site-section">
                <div class="container">
                    <div class="site-block text-center">
                        <a href="<?php echo base_url(); ?>auth/#register" class="btn btn-lg btn-success"><i class="fa fa-shopping-cart"></i> Request Order</a>
                        <a href="<?php echo base_url(); ?>auth/" class="btn btn-lg btn-primary"><i class="fa fa-share"></i> Dashboard Login</a>
                    </div>
                    <hr>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_desktop_left.png" alt="Promo #1" class="img-responsive">
                        </div>
                        <div class="col-sm-6 col-md-5 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            ...
                            <p class="promo-content">ProUI is a professional, modern and solid foundation for your next awesome project. It comes packed with great features that you will love. <a href="<?php echo base_url(); ?>">Learn More..</a></p>
                        </div>
                    </div>
                    <hr>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-5 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            ...
                            <p class="promo-content">ProUI has a powerful and flexible layout to meet every need. It comes packed with 9 awesome and fresh color themes that you will love, too. <a href="<?php echo base_url(); ?>">Learn More..</a></p>
                        </div>
                        <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_desktop_right.png" alt="Promo #2" class="img-responsive">
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <section class="site-content site-section site-slide-content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_tablet.png" alt="Promo #3" class="img-responsive">
                        </div>
                        <div class="col-sm-6 col-md-5 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <h3 class="h2 site-heading site-heading-promo"><strong>Fully</strong> Responsive</h3>
                            <p class="promo-content">The User Interface will just work in mobile phones, tablets, laptops and desktops. You can focus on creating the project you want. <a href="<?php echo base_url(); ?>">Learn More..</a></p>
                        </div>
                    </div>
                    <hr>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-5 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                            ...
                            <p class="promo-content">The layout adjusts as we move up from mobile devices to large desktop screens and not the other way around. This speed things up a lot. <a href="<?php echo base_url(); ?>">Learn More..</a></p>
                        </div>
                        <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                            <img src="<?php echo base_url(); ?>landing/img/placeholders/screenshots/promo_mobile.png" alt="Promo #4" class="img-responsive">
                        </div>
                    </div>
                    <hr>
                </div>
                ...
                <div class="container">
                    ...
                    <div id="testimonials-carousel" class="carousel slide carousel-html" data-ride="carousel" data-interval="4000">
                        ...
                        <div class="carousel-inner text-center">
                            <div class="active item">
                                <p>
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/avatars/avatar12.jpg" alt="Avatar" class="img-circle">
                                </p>
                            ...
                            <div class="item">
                                <p>
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/avatars/avatar7.jpg" alt="Avatar" class="img-circle">
                                </p>
                                <blockquote class="no-symbol">
                            ...
                            <div class="item">
                                <p>
                                    <img src="<?php echo base_url(); ?>landing/img/placeholders/avatars/avatar9.jpg" alt="Avatar" class="img-circle">
                                </p>
                                <blockquote class="no-symbol">
            ...
            <section class="site-content site-section site-section-light themed-background-dark-night">
                <div class="container">
                    ...
                    <div class="site-block text-center">
                        <!--<form action="<?php echo base_url(); ?>" method="post" class="form-horizontal" onsubmit="return false;">-->
            ...
            <footer class="site-footer site-section">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <h4 class="footer-heading"><span id="year-copy">2014</span> &copy; <a href="<?php echo base_url(); ?>">Organized</a></h4>
                            <ul class="footer-nav list-inline">
                                <li>Created with <i class="fa fa-heart text-danger"></i> in Nigeria</li>
                            </ul>
                        </div>
                    </div>
                    <!-- END Footer Links -->
