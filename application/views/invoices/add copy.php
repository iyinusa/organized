                        ...
                        <?php echo form_open_multipart('invoices/add', array('class'=>'form-horizontal form-bordered')); ?>
                            ...
                            <div class="col-lg-6">
								...
								<div class="form-group">
									<div class="btn-group btn-group-justified">
										<div class="btn-group">
										  <button type="button" id="div1_click" class="btn btn-primary <?php echo $pdt_act; ?>" data-toggle="button"><i class="gi gi-cargo"></i> Products</button>
										</div>
								
										<div class="btn-group">
										   <button type="button" id="div2_click" class="btn btn-primary <?php echo $ser_act; ?>"><i class="gi gi-tablet"></i> Services</button>
										</div>
									</div>
								</div>
                                <div id="div1" class="form-group">
                                    <label class="col-md-3 control-label" for="pdt_id">Product</label>
                                    <div class="col-md-9">
                                        <div class="form-inline">
                                            <select id="pdt_id" name="pdt_id" class="select-chosen" data-placeholder="Select Product" onchange="get_pdt_amt(0);">
                                                <option></option>
                                                <?php echo $pdt_list; ?>
                                            </select>
                                            <input type="text" id="qty" name="qty" class="form-control text-center" placeholder="Quatity" value="<?php if(!empty($e_qty)){echo $e_qty;} ?>" onchange="cal_pdt_amt();">
                                        </div>
                                    </div>
                                </div>
                                <div id="div2" class="form-group">
                                    <label class="col-md-3 control-label" for="service_id">Service</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-inline">
                                        	<input type="text" id="discount" name="discount" class="form-control text-center" placeholder="Amount/Percent" value="<?php if(!empty($e_discount)){echo $e_discount;} ?>" onchange="cal_pdt_amt();">
                                            <?php
												if(!empty($e_type)){
