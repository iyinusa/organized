...
var CompCharts = function() {
    ...
    return {
        init: function() {
            ...
            //var dataSales = [[1, 1560], [2, 1650], [3, 1320], [4, 1950], [5, 1800], [6, 2400], [7, 2100], [8, 2550], [9, 3300], [10, 3900], [11, 4200], [12, 4500]];
			var dataSales = sales_array;
            var dataEarnings = expenses_array;
                ...
                [
                    {
                        label: 'Sales',
                        data: dataSales,
                        lines: {show: true, fill: true, fillColor: {colors: [{opacity: 0.35}, {opacity: 0.35}]}},
                ...
                if (item) {
                    if (previousPoint !== item.dataIndex) {
                        ...
                        if (item.seriesIndex === 1) {
							ttlabel = currValue + '<strong>' + y + '</strong> spent';
                        } else {
                            ttlabel = currValue + '<strong>' + y + '</strong> sales';
                        }
